...
function getMoonData(lat, lon) {
    ...
    $.getJSON("https://dataservice.accuweather.com/locations/v1/cities/geoposition/search?apikey=mKw2A9ZvsXV5f4xpisKYTjKyHGidT5uD&q=" + lat + "%2C" + lon, function (data) {

        var locationKey = data.Key

        //Get moon phase at current location
        $.getJSON("https://dataservice.accuweather.com/forecasts/v1/daily/1day/" + locationKey + "?apikey=mKw2A9ZvsXV5f4xpisKYTjKyHGidT5uD&details=true", function (data) {
